...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
       ...
       function openModal() {
        ...
        $(document).ready(function () { //filtrar el datagridview
            $("#myInput").on("keyup", function () {
                ...
                $("#MainContent_gvTransferencia tr").filter(function () {
    ...
    <asp:GridView ID="gvTransferencias" runat="server" AutoGenerateColumns="false"
      CssClass="table table-sm" HeaderStyle-CssClass="thead-dark" 
        ...
        AlternatingRowStyle-BackColor="LightBlue" OnRowCommand="gvTransferencias_RowCommand" >
        <Columns>
            <asp:BoundField HeaderText="Codigo" DataField="Codigo" />
            <asp:BoundField HeaderText="CuentaOrigen" DataField="CuentaOrigen" />
            <asp:BoundField HeaderText="CuentaDestino" DataField="CuentaDestino" />
      ...
      <div class="modal-body">
          <table style="width: 100%;">
              ...
              <tr>
                  ...
                  <td><asp:TextBox ID="txtCuentaOrigen" runat="server" CssClass="form-control" /></td>
              </tr>
              <tr>
                  <td><asp:Literal ID="ltrCuentaDestino" Text="CuentaDestino" runat="server" /></td>
                  <td><asp:TextBox ID="txtCuentaDestino" runat="server" CssClass="form-control" /></td>
              </tr>
              <tr>
                  <td><asp:Literal ID="ltrFechaHora" Text="FechaHora" runat="server" /></td>
                  <td><asp:TextBox ID="txtFechaHora" runat="server" CssClass="form-control" /></td>
              </tr>
              <tr>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Mantenimiento de Transferencia</h4>
      </div>
      <div class="modal-body">
