        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
              <table style="width: 100%;">
                  ...
                  <tr>
                      <td><asp:Literal ID="ltrIBAN" Text="Cuenta IBAN" runat="server" /></td>
                      <td><asp:TextBox ID="txtIBAN" runat="server" Enabled="true" CssClass="form-control" /></td>                     
                      <td><asp:RegularExpressionValidator id="revIBAN" ControlToValidate="txtIBAN" ValidationExpression="(CR050)\d{17}" ErrorMessage="No es formato IBAN" runat="server"/></td>
                  </tr>
                  <tr>
                      <td><asp:Literal ID="ltrSaldo" Text="Saldo" runat="server" /></td>
                      <td><asp:TextBox ID="txtSaldo" runat="server" Enabled="false" CssClass="form-control" /></td>
                  </tr>
                  <tr>
                      <td><asp:Literal ID="ltrEstado" Text="Estado" runat="server" /></td>
