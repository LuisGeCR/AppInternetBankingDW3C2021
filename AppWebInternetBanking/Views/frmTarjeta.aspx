    ...
    <script type="text/javascript">
             ...
             $(document).ready(function () { //filtrar el datagridview
                 $("#myInput").on("keyup", function () {
                     ...
                     $("#MainContent_gvTargetas tr").filter(function () {
        ...
        <asp:GridView ID="gvTarjetas" runat="server" AutoGenerateColumns="false"
          CssClass="table table-sm" HeaderStyle-CssClass="thead-dark" 
            HeaderStyle-BackColor="#243054" HeaderStyle-ForeColor="White" 
            AlternatingRowStyle-BackColor="LightBlue" OnRowCommand="gvTarjetas_RowCommand" >
            <Columns>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
              <table style="width: 100%;">
                  ...
                  <tr>
                      <td><asp:Literal ID="ltrUsuario" Text="Usuario" runat="server" /></td>
                      <td><asp:TextBox ID="txtUsuario" runat="server" CssClass="form-control" /></td>
                  </tr>
                  <tr>
                      <td><asp:Literal Text="Tipo" runat="server" /></td>
                      <td> <asp:DropDownList ID="ddlTipoMant"  CssClass="form-control" runat="server">
                        <asp:ListItem Value="Credito">Credito</asp:ListItem>
                        <asp:ListItem Value="Debito">Debito</asp:ListItem>
                    </asp:DropDownList></td>
                  </tr>
                  <tr>
                      <td><asp:Literal Text="Emisor" runat="server" /></td>
                      <td> <asp:DropDownList ID="ddlEmisorMant"  CssClass="form-control" runat="server">
                  ...
                  <tr>
                      ...
                      <td> <asp:DropDownList ID="ddlCategoriaMant"  CssClass="form-control" runat="server">
                  ...
                  <tr>
                      ...
                      <td><asp:TextBox ID="txtMoneda" runat="server" CssClass="form-control" /></td>
                  </tr>
                  <tr>
      ...
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">Mantenimiento de Solicitudes de Tarjeta</h4>
          </div>
          <div class="modal-body">
