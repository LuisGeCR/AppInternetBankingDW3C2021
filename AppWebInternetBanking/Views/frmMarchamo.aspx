    ...
    <asp:GridView ID="gvMarchamos" runat="server" AutoGenerateColumns="false"
      CssClass="table table-sm" HeaderStyle-CssClass="thead-dark" 
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="Cuanta" DataField="CodigoCuenta" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <table style="width: 100%;">
              ...
              <tr>
                  <td><asp:Literal ID="ltrPlaca" Text="Placa" runat="server" /></td>
                  <td><asp:TextBox ID="txtPlaca" runat="server" CssClass="form-control" /></td>
              </tr>
              <tr>
                  <td><asp:Literal ID="ltrTipo" Text="Tipo" runat="server" /></td>
                  <td><asp:TextBox ID="txtTipo" runat="server" CssClass="form-control" /></td>
              </tr>
              <tr>
