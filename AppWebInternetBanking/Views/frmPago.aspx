    ...
    <asp:GridView ID="gvPagos" runat="server" AutoGenerateColumns="false"
      CssClass="table table-sm" HeaderStyle-CssClass="thead-dark" 
        ...
        <Columns>
            ...
            <asp:BoundField HeaderText="CodigoServicio" DataField="CodigoServicio" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <table style="width: 100%;">
              ...
              <tr>
                  <td><asp:Literal ID="ltrCodigoServicio" Text="CodigoServicio" runat="server" /></td>
                  <td><asp:TextBox ID="txtCodigoServicio" runat="server" Enabled="true" CssClass="form-control" /></td>
              </tr>
              <tr>
               ...
               <tr>
                  ...
                  <td><asp:TextBox ID="txtFechaHora" runat="server" Enabled="true" CssClass="form-control" /></td>
              </tr>
              <tr>
                  <td><asp:Literal ID="ltrMonto" Text="Monto" runat="server" /></td>
                  <td><asp:TextBox ID="txtMonto" runat="server" Enabled="true" CssClass="form-control" /></td>
              </tr>
          </table>
